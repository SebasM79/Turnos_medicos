        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cel = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnidadesTratamiento", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UnidadTratamientoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Especialidades", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Especialidades_UnidadesTratamiento_UnidadTratamientoId",
                        column: x => x.UnidadTratamientoId,
                        principalTable: "UnidadesTratamiento",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medicos_UnidadesTratamiento_UnidadTratamientoId",
                        column: x => x.UnidadTratamientoId,
                        principalTable: "UnidadesTratamiento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicosEspecialidades", x => new { x.MedicoId, x.EspecialidadId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Especialidades_UnidadTratamientoId",
                table: "Especialidades",
                column: "UnidadTratamientoId");

            migrationBuilder.CreateIndex(
                name: "IX_Medicos_UnidadTratamientoId",
                table: "Medicos",
                column: "UnidadTratamientoId");
